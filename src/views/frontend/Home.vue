<template>
  <div>
    ...
    <header class="navbar pc navbar-expand navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <router-link class="nav-link text-primary" to="/about">關於我們</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link text-primary" to="/products/all">產品列表</router-link>
          </li>
          <li class="nav-item dropdown">
            ...
            >用戶選單</a>
            <div
              class="dropdown-menu bg-light dropdown-menu-right"
              aria-labelledby="navbarDropdown"
            >
              <router-link class="dropdown-item text-darken" to="/cart">
                <i class="fa fa-shopping-cart mr-2" aria-hidden="true"></i>購物車頁面
              </router-link>
              <router-link class="dropdown-item text-darken" to="/coupon">
                <i class="fa fa-ticket mr-2" aria-hidden="true"></i>優惠券專區
              </router-link>
              <router-link class="dropdown-item text-darken" to="/like">
                <i class="fa fa-heart mr-2" aria-hidden="true"></i>喜好的項目
              </router-link>
              <div class="dropdown-divider"></div>
              <router-link class="dropdown-item text-darken" to="/login">
    ...
    <header class="navbar mobile-header mobile navbar-expand-lg navbar-light bg-light">
      ...
      <div class="float-right" id="navbarSupportedContent">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
          <router-link class="dropdown-item text-darken" to="/">
            <i class="fa fa-home mr-2" aria-hidden="true"></i>首頁
          </router-link>
          <router-link class="dropdown-item text-darken" to="/about">
            <i class="fa fa-info-circle mr-2" aria-hidden="true"></i>關於我們
          </router-link>
          <router-link class="dropdown-item text-darken" to="/products/all">
    ...
    <router-view class="main-content" v-if="this.$route.path!=='/'" :key="this.$route.fullPath"></router-view>
    ...
    <div class="main-content" v-else>
      <div class="main-img-pc pc">
        ...
        <div class="main-img-pc-caption bg-light text-dark">
          <h2 class="my-3">歡迎光臨拼圖迷❤️</h2>
          <p class="h4">
            市面上【進口拼圖】網路商店的銷售冠軍🏆
            <br />擁有歐洲三大進口拼圖【獨家】代理權！
            <br />銷量第一產品 ➡️
            <b class="text-danger">【紐約天際線-2000片】</b>
            <br />本公司產品【承諾正版保證】- 皆附保證書📖
          </p>
        </div>
        <button
          @click="$router.push('/product/-MN1R8dGkdl9mtI2viKd')"
          class="pc btn main-img-pc-btn btn-outline-dark"
        >
          立即搶購
      ...
      <div class="container">
        <div class="introduction my-5">
          ...
          <div class="row text-success">
            <div class="col-md-4">
              <i class="display-3 text-dark p-2 fa fa-truck" aria-hidden="true" />
              <h2>特快的出貨</h2>
              <p class="lead text-darken">
                當天下訂立即出貨！全店所有商品提供
                <b class="text-danger">十二小時</b>內到貨服務！快讓拼圖迷用最快速的服務把你寵壞
              </p>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <i class="display-3 text-dark fa fa-thumbs-o-up p-2" aria-hidden="true" />
              <h2>簡單的設計</h2>
              <p class="lead text-darken">
        ...
        <div class="news pc my-5">
          ...
          <div class="row mt-5">
            <div class="col-lg-5 align-self-center">
              <img src="@/assets/image/anniversary8.jpg" alt="Happy Anniversary 8" class="w-75" />
            </div>
            <div class="col-lg-7">
              ...
              <button
                type="button"
                class="btn my-4 btn-outline-danger"
                data-toggle="modal"
                data-target="#couponModal"
              >週年慶新客戶加碼送！</button>
              <p class="lead text-primary" style="line-height:40px">
                轉眼間 2020 年了，您的孩子長大了，您也成熟了，而我們，也老了！感謝這一路上多年來所有不管是新客舊客的支持與陪伴！在此宣佈！
                <b
                  class="text-danger"
                >『拼圖迷』八歲囉！！！</b>就讓我們一同歡慶這個美好的節日！感恩回饋不打烊 - 八週年全館
                <u class="text-danger">無低消免運</u> 直接送給您！讓您買到手軟停不下來！一起買爆拼圖吧😊
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="randomproducts my-5">
          ...
          <div class="my-4 text-secondary">
            不喜歡?
            <a class="text-danger" href="#" @click.prevent="randomProducts('隨機推薦已更新!')">點我</a>換一組試試😊
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog text-primary modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h6 class="mb-0">
              <span>點擊複製</span> ☞
              <input class="h4 text-danger copy" type="text" @focus="copy" value="new888" />
              <br />不限金額結帳即享88折優惠
            </h6>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    const vm = this;
    vm.randomProducts();
    vm.$bus.$emit("message:push", "歡迎光臨拼圖迷～❤️", "success");
    vm.getCart();
  },
};
</script>
